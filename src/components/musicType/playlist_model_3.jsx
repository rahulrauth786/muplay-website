...
import { get_app_playlist_genre } from "../../services/playlistService";
...
class Playlist_Model_3 extends Component {
  ...
  async componentDidMount() {
    try {
      let response = await get_app_playlist_genre(this.props.name);
                ...
                <Slider {...settings} ref={(slider) => (this.slider = slider)}>
                  {this.state.app_playlist_meta.map((book) => (
                    <div
                      ...
                      onMouseLeave={() =>
                        this.handlePlayButton(book.image, false)
                      }
                    >
                      <img
                        src={book.image}
                        ...
                        onMouseEnter={() =>
                          this.handlePlayButton(book.image, true)
                        }
                      />{" "}
                      <span
                        style={{
