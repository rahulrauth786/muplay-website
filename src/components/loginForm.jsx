...
class LoginForm extends Component {
  ...
  handleLogin = (optionSel) => {
    this.setState({ showOption: optionSel });
  };
  handleSubmit = async (values) => {
    let data = { userId: values.email, password: values.password };
    try {
  ...
  handleViewPage = (viewPage) => {
    this.setState({ viewPage: viewPage });
  };
  setShow = () => {
  ...
  checkUserExist = async (email) => {
    ...
    const patt = /^(([a-z]{1,}[0-9]{0,5}[@]{1}[a-z]{1,9}[.]{1}[a-z]{2,3})|([0-9]{10}))$/;
      ...
      <>
        <Formik
          ...
          validationSchema={Yup.object({
            ...
            password: Yup.string().required("Date Of Borth is required"),
          })}
                              ...
                              {this.state.showOption === "email" ? (
                                <div className="col-12">
                                  ...
                                  <i
                                    ...
                                    onClick={() =>
                                      this.checkUserExist(values.email)
                                    }
                                  ></i>
                            ...
                            <div className="row pb-5 pt-2">
                              <div className="col-6 text-left">
                                <i
                                  ...
                                  onClick={() => this.handleViewPage("email")}
                                ></i>
                              </div>
