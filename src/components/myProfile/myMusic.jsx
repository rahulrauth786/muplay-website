...
import { getAllPlaylist, addPlaylist } from "../../services/playlistService";
import { getAllFavList } from "../../services/musicService";
...
class Mymusic extends Component {
      ...
      response
        .then(async (data) => {
          try {
            ...
            let response = await getAllPlaylist(token, data[0].id);
  ...
  openPlaylist = (playlist) => {
    ...
    this.props.history.push(`/playlist/${playlist.name}/${playlist.id}`);
  };
  showUserOptions = () => {
                        ...
                        {playlists.map((playlist, index) => (
                          <div className="p-1" key={index}>
                            <img
                              ...
                              onClick={() => this.openPlaylist(playlist)}
                            />
                            <br />
